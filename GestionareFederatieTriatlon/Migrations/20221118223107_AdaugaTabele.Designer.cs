...
namespace GestionareFederatieTriatlon.Migrations
{
    ...
    [Migration("20221118223107_AdaugaTabele")]
    partial class AdaugaTabele
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("GestionareFederatieTriatlon.Entitati.Competitie", b =>
                {
                    ...
                    b.Property<int>("LocatiecodLocatie")
                        .HasColumnType("int");

                    b.Property<int>("TipcodTip")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("LocatiecodLocatie");

                    b.HasIndex("TipcodTip");
            ...
            modelBuilder.Entity("GestionareFederatieTriatlon.Entitati.Conversatie", b =>
                {
                    ...
                    b.HasKey("codConversatie", "UserId", "codChat");
            ...
            modelBuilder.Entity("GestionareFederatieTriatlon.Entitati.Istoric", b =>
                {
                    ...
                    b.HasKey("SportivId", "codProba", "codCompetitie");
            ...
            modelBuilder.Entity("GestionareFederatieTriatlon.Entitati.Recenzie", b =>
                {
                    ...
                    b.Property<int>("CompetitiecodCompetitie")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("CompetitiecodCompetitie");
            ...
            modelBuilder.Entity("GestionareFederatieTriatlon.Entitati.Competitie", b =>
                {
                    b.HasOne("GestionareFederatieTriatlon.Entitati.Locatie", "Locatie")
                        .WithMany("Competitii")
                        .HasForeignKey("LocatiecodLocatie")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("GestionareFederatieTriatlon.Entitati.Tip", "Tip")
                        .WithMany("Competitii")
                        .HasForeignKey("TipcodTip")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("GestionareFederatieTriatlon.Entitati.Recenzie", b =>
                {
                    b.HasOne("GestionareFederatieTriatlon.Entitati.Competitie", "Competitie")
                        .WithMany("Recenzii")
                        .HasForeignKey("CompetitiecodCompetitie")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("GestionareFederatieTriatlon.Entitati.Videoclip", b =>
                {
                    b.HasOne("GestionareFederatieTriatlon.Entitati.Competitie", "Competitie")
                        .WithOne("Videoclip")
                        .HasForeignKey("GestionareFederatieTriatlon.Entitati.Videoclip", "CompetitiecodCompetitie")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
